...
export const mockRequests: Request[] = [
  {
    ...
    context: {
      ...
      history: ['Transferred from Growth on April 18', 'Last access review completed 2 weeks ago'],
    },
  ...
  },
  {
    ...
    context: {
      ...
      history: ['Endpoint patch installed at 02:13', 'Battery replaced last quarter'],
    },
  ...
  },
  {
    ...
    context: {
      ...
      device: 'MacBook Air',
      history: ['HR handbook viewed last month', 'Payroll profile updated this quarter'],
    },
  ...
  },
  {
    ...
    context: {
      ...
      history: ['Expense submitted on April 9', 'Manager approval completed on April 10'],
    },
    activityLog: ['Request submitted in employee portal'],
  },
  {
    ...
    context: {
      ...
      history: ['Contractor onboarding started this morning', 'No app bundle assigned yet'],
    },
    activityLog: ['Request received via Slack'],
  },
  {
    ...
    context: {
      ...
      history: ['Manager changed this week', 'Shared folder ownership recently updated'],
    },
    activityLog: ['Email ingested into support queue'],
  },
]
